...
alter table Incident drop foreign key FK909A8F2F5679207;
...
create table Priority (id bigint not null auto_increment, description varchar(255), duration integer not null, response integer not null, impact_id bigint, urgency_id bigint, primary key (id)) ENGINE=InnoDB;
...
alter table Incident add index FK909A8F2F5679207 (priority_id), add constraint FK909A8F2F5679207 foreign key (priority_id) references Priority (id);
