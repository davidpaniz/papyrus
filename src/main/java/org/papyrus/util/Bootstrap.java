...
public class Bootstrap {
	...
	public void loadBootstrap(User adminUser, boolean shouldLoadBootStrap) throws HibernateException, IOException {
	...
	private void loadBootstrap(Session session) {
	...
	public static void main(String... args) throws IOException {
		...
		bootstrap.loadBootstrap(user, true);
	}
}
